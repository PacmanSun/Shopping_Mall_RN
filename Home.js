...
export default class Home extends Component<Props> {
  static navigationOptions = {
    ...
    header: Platform.select({
      ios:'null',
    //   android:<View style={{flexDirection: 'row',height:40,justifyContent: 'space-around',}}>
    //           <TextInput style={{
    //             borderColor: 'gray',
    //             borderWidth: 2,
    //             borderRadius: 4,
    ...
    //           <View style={{marginRight:10,marginTop:1,marginBottom:1}}>
    //             <Button style={{}}
    //               title="搜 索"
...
//使用Swiper
  ...
  _renderRow(rowData){
    return (
      <TouchableHighlight onPress={()=>this.props.navigation.navigate('Details',{title:rowData.title,subTitle:rowData.subTitle})}>
    ...
    return (
      <View  style={styles.container}>
        ...
        <View style={styles.searchbar}>
          ...
          <View style={{marginRight:10,marginTop:2,marginBottom:2}}>
